---
as_of: 2026-07-15
latest_financial_period: 2025-12-31
price: 0.94
price_currency: SGD
analysis_type: initial-profile
---

# Initial company profile

This is an initial evidence review, not a deliberate thesis review. The thesis
remains unreviewed. It does not estimate intrinsic value or claim a margin of
safety.

## Executive read

- **Reported fact:** Raffles Medical Group (RMG) is a founder-controlled,
  integrated Asian private-healthcare group spanning primary care, hospitals,
...
- **Agent inference:** The balance sheet and integrated Singapore franchise give
  RMG resilience, but the evidence does not yet establish high returns on
  incremental capital. Greater China held 30.7% of geographically allocated
  non-current assets but produced only 8.5% of revenue, and the Shanghai and
  Chongqing hospitals continued to make operating losses.
- **Calculated metric:** At the SGD 0.940 close on 2026-07-15, the shares were
  only 4.4% above their 52-week low, but still traded at about 24.7 times FY2025
  diluted EPS and 1.63 times book value. A low position in the trading range is
  not, by itself, evidence of undervaluation.

## Business profile

| Reportable segment | What it does | FY2025 reported segment revenue | FY2025 segment PBT | Initial observation |
|---|---|---:|---:|---|
| Healthcare Services | Clinics and general medical services; pharmaceutical, nutraceutical, and diagnostic-equipment trading; management, consultancy, and third-party administration | SGD 285.9m | SGD 42.5m | **Agent inference:** Established clinic and corporate-care network, but FY2025 revenue fell 3.1% and PBT fell 5.8%. The post-COVID earnings base still needs normalization. |
| Hospital Services | Specialist medical services, hospitals, laboratories, and imaging | SGD 357.8m | SGD 41.1m | **Reported fact:** Revenue rose 3.5% and PBT rose 15.3%; this was the main FY2025 growth engine. |
| Insurance Services | Health-insurance products | SGD 185.2m | SGD (3.1)m | **Reported fact:** Revenue rose 4.1% and the pretax loss narrowed by 50.6%, but the segment did not make a pretax profit. |
| Investment Holdings | Investment holdings and investment properties | SGD 44.3m | SGD 27.2m | **Agent inference:** High reported margin is not comparable with operating healthcare segments and includes property/investment economics. |
...
claims control. The filings do not quantify those synergies, so they should be
treated as a hypothesis rather than an established moat.

## Financial record and quality

### Five-year reported record

| SGD million except per-share data | 2021 | 2022 | 2023 | 2024 | 2025 |
|---|---:|---:|---:|---:|---:|
| Revenue | 723.8 | 822.9 | 706.9 | 751.6 | 765.3 |
| EBITDA | 160.6 | 235.7 | 154.1 | 125.7 | 135.0 |
| PATMI | 84.2 | 143.2 | 90.2 | 62.2 | 70.6 |
| Diluted EPS, SGD | 0.0449 | 0.0767 | 0.0482 | 0.0334 | 0.0381 |
| Dividend per share, SGD | 0.028 | 0.038 | 0.024 | 0.025 | 0.030 |
| ROE | 8.8% | 14.1% | 8.8% | 5.9% | 6.7% |

All figures are reported facts. Management attributed the unusually high earlier
...
| Metric | Result | Classification | Comment |
|---|---:|---|---|
| Revenue growth | 1.83% | Calculated metric | Modest top-line growth |
| EBITDA margin | 17.64% | Calculated metric | Up from 16.72% in FY2024 |
| Operating margin | 11.81% | Calculated metric | Up from 10.98% in FY2024 |
| PATMI margin | 9.22% | Calculated metric | Up from 8.28% in FY2024 |
| Operating cash flow / PATMI | 143.6% | Calculated metric | Strong one-year conversion, but insurance working-capital movements can be volatile |
...
- **Reported fact:** Operating cash flow was SGD 101.3 million. Cash purchases
  of property, plant and equipment and intangibles were SGD 10.0 million, and
  lease-principal payments were SGD 11.4 million.
- **Calculated metric:** A simple cash free-cash-flow proxy is SGD 91.3 million
  before lease principal and SGD 79.9 million after lease principal. These are
  not normalized owner earnings because maintenance versus growth spending is
  not yet separated.
...
| Geography | FY2025 revenue | Share of revenue | Non-current assets | Share of allocated non-current assets |
|---|---:|---:|---:|---:|
| Singapore | SGD 680.8m | 89.0% | SGD 671.5m | 67.9% |
| Greater China | SGD 65.4m | 8.5% | SGD 304.0m | 30.7% |
| Rest of Asia | SGD 19.1m | 2.5% | SGD 13.4m | 1.4% |
...
- **Agent inference:** China is a material capital-allocation test, not yet a
  ...
  cash-flow disclosure prevents a return-on-invested-capital assessment.

## Balance sheet and asset backing

| FY2025 reported item | SGD million | Per current disclosed share |
|---|---:|---:|
| Cash and cash equivalents | 310.8 | 0.169 |
| Borrowings | (49.7) | (0.027) |
| Net cash before leases | 261.1 | 0.142 |
| Lease liabilities | (37.7) | (0.020) |
| Net cash after leases | 223.4 | 0.121 |
| Investment properties at fair value | 233.6 | 0.127 |
| Equity attributable to owners | 1,058.5 | 0.575 |
...
properties are necessary for the healthcare business, investment properties
already sit in book value, and China valuations use Level 3 assumptions.
...
| Metric | Value | Basis |
|---|---:|---|
| Price | SGD 0.940 | Delayed close / last trade |
| 52-week range | SGD 0.900-1.090 | Price sits 21.1% of the way from low to high |
| Market capitalisation | SGD 1.730bn | Price × latest disclosed issued shares excluding treasury |
| Reported P/E | 24.67x | Price / FY2025 diluted EPS of SGD 0.0381 |
| Reported earnings yield | 4.05% | FY2025 diluted EPS / price |
| Price / book | 1.63x | Market cap / FY2025 equity attributable to owners |
| Price / sales | 2.26x | Market cap / FY2025 revenue |
| EV / EBITDA, including leases | 11.16x | Market cap + borrowings + leases - cash, divided by FY2025 EBITDA |
| FY2025 final-dividend yield | 3.19% | SGD 0.030 / price |
| Cash FCF yield before lease principal | 5.28% | One-year proxy; not normalized owner earnings |
...
continued margin improvement. A completed intrinsic-value range must wait for a
normalized owner-earnings estimate and a separate assessment of operating and
investment properties.

## Ownership and governance

- **Reported fact:** Founder Dr Loo Choon Yong is Executive Chairman and CEO.
  After buying 522,000 shares at SGD 0.95 on 2026-05-18, his direct and deemed
...
roles, Audit & Risk Committee composition, related-party controls, and capital
allocation deserve continuing scrutiny rather than an automatic governance
premium or discount.

## Strongest evidence for and against further work

### Supports continued research

- **Reported fact:** A sizeable, integrated Singapore healthcare franchise with
  a long operating history and broad service coverage.
- **Reported fact:** FY2025 hospital profit growth of 15.3%, rising group
  margins, and net cash.
- **Calculated metric:** One-year operating cash flow exceeded PATMI and the
  lease-adjusted cash FCF proxy was SGD 79.9 million.
- **Agent inference:** Owned properties, investment properties, and net cash
  create balance-sheet optionality, provided they can earn adequate returns.

### Contrary evidence and unresolved risks

- **Reported fact:** Shanghai and Chongqing remain loss-making and require
...
- **Reported fact:** A single undisclosed customer accounts for 16.2% of group
  revenue.
- **Reported fact:** The founder controls 56.313%; two children sit on the Board,
  and one is on the Audit & Risk Committee.
- **Calculated metric:** A 24.7x reported P/E and 4.1% earnings yield do not
  provide a visible margin of safety without stronger normalized economics.

## Next evidence needed

1. Build a pre-COVID, COVID, and post-COVID normalized earnings bridge covering
   at least ten years.
2. Separate maintenance from growth capital expenditure and reconcile cash
   capex, right-of-use additions, and lease principal to owner earnings.
3. Obtain China hospital revenue, operating loss, patient volume, occupancy,
   capacity, cash burn, and expected breakeven data by hospital.
4. Obtain Raffles Health Insurance's loss ratio, expense ratio, capital
   requirements, and profitability by product line.
5. Identify the major customer and assess renewal, pricing, and concentration
   risk.
6. Review property valuations and determine which assets are operationally
...
**Agent inference:** RMG looks like a resilient, cash-generative Singapore
healthcare platform with a strong balance sheet and improving FY2025 hospital
economics. The current evidence does not yet show that China earns an adequate
return, that insurance has reached sustainable profitability, or that the SGD
0.940 price offers conservative value. The correct status is therefore
`candidate`: worthy of deeper normalization and valuation work, with no buy,
sell, position-size, intrinsic-value, or margin-of-safety conclusion.
